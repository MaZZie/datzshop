<div @click.away="open = false"
    ...
    <nav :class="{'block': open, 'hidden': !open}" class="flex-grow md:block px-4 pb-4 md:pb-0 md:overflow-y-auto">
        {{-- Account settings --}}
        <div :class="{'block': !open, 'hidden': open}" class="mb-3 relative">
            <x-jet-dropdown align="left" width="full">
                <x-slot name="trigger">
                    @if (Laravel\Jetstream\Jetstream::managesProfilePhotos())
                    <div class="flex">
                        <button
                            class="ml-3 mr-3 mt-2 flex text-sm border-2 border-transparent rounded-full focus:outline-none focus:border-gray-300 transition">
        ...
        <div :class="{'block': open, 'hidden': !open}">
            <button @click="openProfile = !openProfile" class="flex items-center px-4 w-full
          focus:outline-none transition">
            ...
            <div :class="{'block': openProfile, 'hidden': ! openProfile}" class="hidden sm:hidden ml-20">
